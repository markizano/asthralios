...
- **No JIT (just-in-time) imports.** All `import` statements must be at the top of the module, never inside functions or methods. This applies everywhere in the codebase without exception.
